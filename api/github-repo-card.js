...
module.exports = async (req, res) => {
  try {
    ...
    ` : ''}
        ...
        <text data-testid="stargazers" class="datatext" x="200" y="12">${repoData.stargazers_count}</text>
        ...
        <text data-testid="forkcount" class="datatext" x="320" y="12">${repoData.forks_count}</text>
      </g>
    </g>
    </svg>
    `;
